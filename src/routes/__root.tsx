...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Linkode — Open Your Links Outside Facebook App" },
      { name: "twitter:title", content: "Linkode — Open Your Links Outside Facebook App" },
      { property: "og:description", content: "Linkode helps creators redirect URLs out of restrictive in-app browsers and into native browsers like Chrome and Safari for a faster, smoother experience." },
      { name: "twitter:description", content: "Linkode helps creators redirect URLs out of restrictive in-app browsers and into native browsers like Chrome and Safari for a faster, smoother experience." },
