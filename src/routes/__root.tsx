...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Linkode — Open Your Links in External Browser" },
      ...
      { property: "og:title", content: "Linkode — Open Your Links in External Browser" },
      { name: "twitter:title", content: "Linkode — Open Your Links in External Browser" },
